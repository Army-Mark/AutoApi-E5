...
requests.get('https://sctapi.ftqq.com/SCT89749TUALbuyC7wr58Oh3Y6dLOeLjF.send?title=E5续期调用API权限10次运行完毕（163）')
requests.get('http://pushplus.hxtrip.com/send?token=d36368b7540a4d86aad9a1217c041cf7&title=163&content=E5续期调用API权限10次运行完毕')
